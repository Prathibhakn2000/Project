...
<div class="d-flex justify-content-center mt-3 mb-2 align-items-center vh-80">
  <div class="card highlight-card" style="width: 40%; padding: 20px;">
    <div class="card-body">
      <h3><b><center>Dept Admin Forgot Password</center></b></h3>
      <form action="deptadmin-forgot-password" method="post">
        <center><strong><span style="color:green">${forgotMessage}</span></strong></center>
        <center><strong><span style="color:green">${forgotError}</span></strong></center>
